package com.garcia.algafoodapi.core.security;
...
public @interface CheckSecurity {
  ...
  public @interface Pedidos {
    ...
    @PreAuthorize(
        "@algaSecurity.podePesquisarPedidos(#pedidoFilter.clienteId, #pedidoFilter.restauranteId)")
    @Retention(RUNTIME)
    @Target(METHOD)
  ...
  public @interface UsuariosGruposPermissoes {
    ...
    @PreAuthorize(
        "hasAuthority('SCOPE_WRITE') and " + "@algaSecurity.usuarioAutenticadoIgual(#usuarioId)")
    @Retention(RUNTIME)
    @Target(METHOD)
    public @interface PodeAlterarPropriaSenha {}

    @PreAuthorize(
        "hasAuthority('SCOPE_WRITE') and (hasAuthority('EDITAR_USUARIOS_GRUPOS_PERMISSOES') or "
