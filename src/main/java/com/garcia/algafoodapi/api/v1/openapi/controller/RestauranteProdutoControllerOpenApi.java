...
public interface RestauranteProdutoControllerOpenApi {
  ...
  @Operation(
      ...
      responses = {
        ...
        @ApiResponse(
            responseCode = "400",
            description = "ID do restaurante ou do produto inválidos",
            content = {@Content(schema = @Schema(ref = "Problema"))}),
        @ApiResponse(
            responseCode = "404",
            description = "Restaurante ou produto não encontrados",
            content = {@Content(schema = @Schema(ref = "Problema"))})
      })
  ProdutoModel buscar(
      @Parameter(description = "ID do restaurante", example = "1", required = true)
  ...
  ProdutoModel adicionar(
      @Parameter(description = "ID do restaurante", example = "1", required = true)
          Long restauranteId,
      @RequestBody(description = "Representação de um produto", required = true)
