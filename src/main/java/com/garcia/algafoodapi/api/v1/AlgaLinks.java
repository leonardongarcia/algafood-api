package com.garcia.algafoodapi.api.v1;

import com.garcia.algafoodapi.api.v1.controller.*;
...
public class AlgaLinks {
  ...
  public static final TemplateVariables PROJECAO_VARIABLES =
      new TemplateVariables(new TemplateVariable("projecao", VariableType.REQUEST_PARAM));

  public static final TemplateVariables PAGINACAO_VARIABLES =
  ...
  public Link linkToPedidos(String rel) {
    TemplateVariables filtroVariables =
        new TemplateVariables(
  ...
  public Link linkToGrupoPermissaoDissociacao(Long grupoId, Long permissaoId, String rel) {
    return linkTo(methodOn(GrupoPermissaoController.class).dissociar(grupoId, permissaoId))
        .withRel(rel);
  }
  ...
  public Link linkToUsuarioGrupoDissociacao(Long usuarioId, Long grupoId, String rel) {
    return linkTo(methodOn(UsuarioGrupoController.class).dissociar(usuarioId, grupoId))
        .withRel(rel);
  }
  ...
  public Link linkToEstatisticasVendasDiarias(String rel) {
    ...
    String pedidosUrl =
        linkTo(methodOn(EstatisticasController.class).consultarVendasDiarias(null, null))
            .toUri()
            .toString();
