...
public class AlgaLinks {
    ...
    public Link linkToRestauranteFormaPagamentoDissociacao(
        ...
        return linkTo(methodOn(RestauranteFormaPagamentoController.class)
                .dissociar(restauranteId, formaPagamentoId)).withRel(rel);
    }
    ...
    public Link linkToRestauranteResponsavelDissociacao(
        ...
        return linkTo(methodOn(RestauranteUsuarioResponsavelController.class)
                .dissociar(restauranteId, usuarioId)).withRel(rel);
    }
    ...
    public Link linkToFotoProduto(Long restauranteId, Long produtoId, String rel) throws HttpMediaTypeNotAcceptableException {
        return linkTo(methodOn(RestauranteProdutoFotoController.class)
                .buscar(restauranteId, produtoId, null)).withRel(rel);
    }

    public Link linkToFotoProduto(Long restauranteId, Long produtoId) throws HttpMediaTypeNotAcceptableException {
    ...
    public Link linkToUsuarioGrupoDissociacao(Long usuarioId, Long grupoId, String rel) {
        return linkTo(methodOn(UsuarioGrupoController.class)
                .dissociar(usuarioId, grupoId)).withRel(rel);
    }
