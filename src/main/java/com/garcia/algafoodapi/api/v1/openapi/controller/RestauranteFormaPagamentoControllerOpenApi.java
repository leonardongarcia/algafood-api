...
public interface RestauranteFormaPagamentoControllerOpenApi {
  ...
  @Operation(
      summary = "Lista as formas de pagamento associadas a um restaurante",
      responses = {
  ...
  @Operation(
      summary = "Dissocia uma forma de pagamento de um restaurante",
      responses = {
        @ApiResponse(responseCode = "204"),
        @ApiResponse(
            responseCode = "400",
            description = "ID do restaurante ou da forma de pagamento inválidos",
            content = {@Content(schema = @Schema(ref = "Problema"))}),
        @ApiResponse(
            responseCode = "404",
            description = "Restaurante ou forma de pagamento não encontrados",
            content = {@Content(schema = @Schema(ref = "Problema"))})
      })
  ...
  @Operation(
      summary = "Associa uma forma de pagamento a um restaurante",
      responses = {
        @ApiResponse(responseCode = "204"),
        @ApiResponse(
            responseCode = "404",
